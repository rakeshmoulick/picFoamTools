...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
figsize = np.array([80,50]) #Figure size in mm (FOR SINGLE FIGURE)
...
ax.axhline(hline,linestyle='--',color='grey',linewidth=1.0, label='$T_{avg}$')

ax.plot(t/1e-9,TA,'r',linestyle='-',linewidth=1.0,label='$T_{Ne}$')
ax.plot(t/1e-9,TB,'b',linestyle='-',linewidth=1.0,label='$T_{Ar}$')
